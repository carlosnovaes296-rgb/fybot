export const translations = {
  en: {
    ...
    plans: {
      ...
      card4Features: ["Gain free access to trade 24 hours.", "For 90 days"],
      card5Title: "Bot Pro License",
      card5Desc: "Access to the bot for 90 days.",
      card5Features: ["90 Days License"],
  ...
  pt: {
    ...
    plans: {
      ...
      card4Features: ["Ganha acesso livre para operar 24 horas.", "Durante 90 dias"],
      card5Title: "Licença Bot Pro",
      card5Desc: "Acesso ao robô para 90 dias.",
      card5Features: ["Licença de 90 dias"],
      card6Title: "Licença Sniper",
      card6Desc: "Duração 120 dias.",
      card6Features: ["Duração 120 dias"],
      period: "DIAS"
    },
    installation: {
  ...
  es: {
    ...
    plans: {
      ...
      card4Features: ["Gana acceso libre para operar 24 horas.", "Durante 90 días"],
      card5Title: "Licencia Bot Pro",
      card5Desc: "Acceso al bot por 90 días.",
      card5Features: ["Licencia de 90 días"],
      card6Title: "SNIPER 1X1",
